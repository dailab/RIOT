...
#else
#define CC1200_PACKET_LENGTH        (0xFF)  /**< max packet length = 255b */
#endif /* MODULE_CC1200 */
...
#else
#define CC1200_DEFAULT_CHANNEL      (0)     /**< The default channel number */
#endif
#endif
#define CC1200_MIN_CHANNR           (0)     /**< lowest possible channel number */
#define CC1200_MAX_CHANNR           (0)     /**< highest possible channel number */
